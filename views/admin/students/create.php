...
<body>
    ...
    <form action="" method="POST" class="card-body" style="width:50%;margin-left:25%;padding-left:5%;padding-right:5%;" enctype="multipart/form-data">
        ...
        <input type="number" name="student_id" class="form-control" id="" placeholder="ID" style="background-color:bbd0c9">
        ...
        <label for="name">ADMITTED SEMESTER:</label>
        <input type="name" name="admission_semester" class="form-control" id="" placeholder="ADMITTED SEMESTER"style="background-color:bbd0c9">
        <br>

        <a href="../../../views/admin/students/index.php" class="btn btn-warning">BACK TO LIST</a>
