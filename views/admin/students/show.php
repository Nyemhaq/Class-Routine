...
<body>
  ...
  <a class="btn btn-warning float-start" style="margin-left:12px; margin-top:12px;" href="../students/index.php">Back to the list</a>



  <footer style="padding-left: 45%;margin-top:100px;">Created by Nyem & Sakib @2022</footer>
